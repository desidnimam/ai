      ...
      >
        <div className="relative mx-auto flex w-full max-w-5xl items-center justify-center border border-slate-200 p-4 dark:border-slate-800">
          ...
          <div className="z-20 w-full">
            <ScrollArea className="h-60 w-full overflow-y-auto p-2 md:p-4">
              <div className="px-6">
                ...
                <p className="md:text-md lg:text-md mx-auto mb-8 mt-2 px-6 text-center text-xs text-slate-600 dark:text-slate-400 sm:px-6 md:max-w-2xl md:px-20">
